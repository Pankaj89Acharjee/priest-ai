...
const RegisterPage = () => {
  ...
  const { formData, errors, isLoading, setField, setLoading, validateForm, resetForm } = useRegisterStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await registerUser(formData.email, formData.password, formData.displayName, formData.isPriest);
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className={`appearance-none rounded-none relative block w-full px-3 py-2 border ${errors.displayName ? 'border-red-300' : 'border-gray-300'
